  ...
  handler: async (ctx, args) => {
    ...
    return {
      ...
      currentTurn: currentTurn ? {
        _id: currentTurn._id,
        _creationTime: currentTurn._creationTime,
        gameId: currentTurn.gameId,
        playerId: currentTurn.playerId,
        picks: currentTurn.picks,
        resolved: currentTurn.resolved,
        correct: currentTurn.correct,
        startedAt: currentTurn.startedAt,
        resolvedAt: currentTurn.resolvedAt,
      } : undefined,
    };
  },
});
