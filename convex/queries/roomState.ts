...
// export const roomStateWithCurrentUser = sessionQuery({
//   args: {
//     code: v.string()
//   },
//   returns: v.union(
...
//     // Find current user's membership based on session
//     let currentUser = null;
//     if (ctx.session?.userId) {
//       currentUser = validMembers.find(member => member.userId === ctx.session!.userId) || null;
//     }
