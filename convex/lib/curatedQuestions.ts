export const curatedQuestionsData: Record<string, Record<number, string[]>> = {
  "Getting to Know You": {
    1: [ // icebreaker
      ...
      "What's a small habit that makes you happy?",
      "What's the first thing you notice about someone new?"
    ],
    2: [ // personal
    ...
    3: [ // deep
      ...
      "What's one truth you wish more people knew?"
    ]
  },
  ...
  "Favorites": {
    ...
    3: [ // deep
      ...
      "Favorite trait about the teammate you're playing with?",
      "Favorite memory with your family?",
      "Favorite tradition you have?",
      ...
      "Favorite risk you've ever taken?"
    ]
  },
  ...
  "Hypotheticals": {
    ...
    2: [
      ...
      // "If you could get rid of one of your memories, which one would it be?",
      ...
      "If you had to move to another country tomorrow, which one would you choose?"
    ],
    3: [
      ...
      "If you had one message to leave behind, what would it say?"
    ]
  },
  ...
  "University Life": {
    ...
    3: [ // future
      ...
      "What's one way university has changed you?"
    ]
  },
  ...
  "Dreams and Aspirations": {
    ...
    2: [
      ...
      "How do you want to be remembered?",
      "What does 'success' mean to you?",
      "What's a risk you want to take soon?"
    ],
    3: [
  ...
  "Last Time I...": {
    1: [
      ...
      "The last time you ordered takeout?"
    ],
    2: [
    ...
    3: [
      ...
      "The last time you told someone you loved them?"
    ]
  },
  ...
  "All bout books": {
    ...
    2: [
      "Favorite book you've read in the last year?",
      "Favorite piece of art (song, painting, film, etc.)?",
      "Book that made you think differently?"
    ],
    3: [
  ...
  "All bout music": {
    ...
    3: [
      ...
      "Song that defines a season of your life?"
    ]
  },
  ...
  "All bout games": {
    1: [
      ...
      "Game you always win at?"
    ],
    2: [
      "Your favorite way to spend a weekend?",
      "Favorite app on your phone?",
      "Game you've played the longest?"
    ],
    3: [
      "Game that brings back the best memories?"
    ]
  },
  ...
  "All bout food": {
    ...
    3: [
      "Food that reminds you most of home?"
    ]
  },
  ...
  "All bout travel": {
    ...
    3: [
      "Trip that changed how you see the world?"
    ]
  }
};
